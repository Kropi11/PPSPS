    ...
    public class GenerateRecoveryCodesModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (!isTwoFactorEnabled)
            {
                ...
                throw new InvalidOperationException($"Nelze generovat kódy pro obnovení pro uživatele s ID '{userId}' protože nemá povolenou 2FA.");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "Byly Vám vygenerovány nové kódy pro obnovení.";
