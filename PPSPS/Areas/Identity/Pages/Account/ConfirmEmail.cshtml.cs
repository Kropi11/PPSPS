...
namespace PPSPS.Areas.Identity.Pages.Account
{
    ...
    public class ConfirmEmailModel : PageModel
    {
        ...
        public ConfirmEmailModel(UserManager<PPSPSUser> userManager)
        {
        ...
        public async Task<IActionResult> OnGetAsync(string userId, string code)
        {
            ...
            StatusMessage = result.Succeeded ? "Děkujeme za potvrzení vašeho e-mailu." : "E-mail nebylo možné ověřit.";
            return Page();
        }
    }
}
